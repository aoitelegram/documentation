...
`callback` introduces a new way of creating functions in `aoitelegram` that are more flexible and have slightly more capabilities than regular [custom functions](./pluginmanager.mdx).
