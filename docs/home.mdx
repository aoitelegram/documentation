...
:::note{.warning}
Documentation will always be updated to reflect the latest changes! Descriptions of some functions may be unclear – these will be corrected/modified, so please don't beat me 😭. [GitHub docs](https://github.com/Sempai-07/aoiwebsite)
:::
